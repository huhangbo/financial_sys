  ...
  return (
    <div>
      ...
      <Table
        ...
        pagination={{position: []}}
        dataSource={list} />
      <AdminUser key = "form" open={open} onCreate={() => {setOpen(false)}} setList={setList} list={list}
  ...
  return (
    ...
    >
      <Form
        ...
        initialValues={info}
      >
        <Form.Item name="news_id" label="编号"
                   rules={[{ required: !isAdd, message: 'Please input the title of collection!' }]}
        >
          <Input disabled={true}/>
        </Form.Item>
  ...
  return (
    <div>
      ...
      <Table
        ...
        pagination={{position: []}}
        dataSource={list} />
      <AdminNews key = "form" open={open} onCreate={() => {setOpen(false)}} setList={setList} list={list}
                 onCancel={() => {setOpen(false)}} info={selectInfo} isAdd={isAdd}/>
    </div>
  );
  ...
  return (
    ...
    >
      <Form
        ...
        initialValues={info}
      >
        <Form.Item name="category_id" label="编号"
                   rules={[{ required: !isAdd, message: 'Please input the title of collection!' }]}
        >
          <Input disabled={true}/>
        </Form.Item>
  ...
  return (
    <div>
      ...
      <Table
        ...
        pagination={{position: []}}
        dataSource={list} />
      <AdminCategory key = "form" open={open} onCreate={() => {setOpen(false)}} setList={setList} list={list}
                 onCancel={() => {setOpen(false)}} info={selectInfo} isAdd={isAdd}/>
    </div>
  );
